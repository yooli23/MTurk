...
import utils.mturk_utils as mturk_utils
from config.settings import mturk as mturk_config
...
class API:
    ...
    def create_hit(self, hit_type_id, task_group_id):
        ...
        try:
            ...
            db = Database()
            db.link_task_group_id(hit_id, task_group_id) 
    ...
    def worker_complete_task(self, worker_id, assignment_id, hit_id, task_group_id, pay_bonus=False):
        ...
        # Paying bonus
        if pay_bonus and float(mturk_config['bonus']) > 0:
